...
export function DoctorSidebar({ className }: { className?: string }) {
  ...
  const mainNavItems: NavItem[] = [
    { title: "Dashboard", icon: BarChart3, href: "/therapist/home" },
    { title: "Patients", icon: Users, href: "/therapist/patients" },
    { title: "Appointments", icon: Calendar, href: "/therapist/appointments" },
    { title: "Chats", icon: MessageSquare, href: "/chats", badge: "3" },
    { title: "Therapy Sessions", icon: Brain, href: "/therapist/sessions" },
    { title: "Treatment Plans", icon: Clipboard, href: "/therapist/treatment-plans" },
    { title: "Mental Health Records", icon: FileText, href: "/therapist/records" },
  ];
