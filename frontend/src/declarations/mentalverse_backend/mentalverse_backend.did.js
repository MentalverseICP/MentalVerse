export const idlFactory = ({ IDL }) => {
  ...
  const Result_39 = IDL.Variant({ 'ok' : AppointmentId, 'err' : IDL.Text });
  ...
  const Result_29 = IDL.Variant({ 'ok' : Doctor, 'err' : IDL.Text });
  const RecordId = IDL.Text;
  const PHIDataType = IDL.Variant({
    'labResults' : IDL.Null,
    'sessionNotes' : IDL.Null,
  ...
  const MedicalRecord = IDL.Record({
    ...
    'recordType' : IDL.Text,
    'updatedAt' : IDL.Int,
    'encryptedAttachments' : IDL.Opt(EncryptedPHI),
    'isConfidential' : IDL.Bool,
    'accessPermissions' : IDL.Vec(UserId),
    'attachments' : IDL.Vec(IDL.Text),
    'appointmentId' : IDL.Opt(AppointmentId),
    'encryptedDescription' : IDL.Opt(EncryptedPHI),
  });
  const Result_27 = IDL.Variant({ 'ok' : MedicalRecord, 'err' : IDL.Text });
  const Patient = IDL.Record({
    ...
    'encryptedPhoneNumber' : IDL.Opt(EncryptedPHI),
    'email' : IDL.Text,
    ...
    'lastName' : IDL.Text,
    'encryptedDateOfBirth' : IDL.Opt(EncryptedPHI),
    'allergies' : IDL.Vec(IDL.Text),
    'encryptedEmergencyContact' : IDL.Opt(EncryptedPHI),
    'currentMedications' : IDL.Vec(IDL.Text),
    'firstName' : IDL.Text,
  });
  const Result_26 = IDL.Variant({ 'ok' : Patient, 'err' : IDL.Text });
  ...
  const Result_38 = IDL.Variant({ 'ok' : Prescription, 'err' : IDL.Text });
  ...
  const Result_37 = IDL.Variant({ 'ok' : SessionNote, 'err' : IDL.Text });
  ...
  const Result_21 = IDL.Variant({ 'ok' : Therapist, 'err' : IDL.Text });
  ...
  const Result_36 = IDL.Variant({ 'ok' : Conversation, 'err' : IDL.Text });
  ...
  const Result_35 = IDL.Variant({ 'ok' : TreatmentSummary, 'err' : IDL.Text });
  ...
  const Result_33 = IDL.Variant({ 'ok' : IDL.Vec(AuditLog), 'err' : IDL.Text });
  const Result_32 = IDL.Variant({
    'ok' : IDL.Record({
      'recentCriticalEvents' : IDL.Vec(AuditLog),
      'totalEvents' : IDL.Nat,
      'medicalRecordAccess' : IDL.Nat,
      'securityEvents' : IDL.Nat,
      'userRegistrations' : IDL.Nat,
  ...
  const EncryptedPatientPHI = IDL.Record({
    'patientId' : UserId,
    'encryptedCurrentMedications' : IDL.Opt(EncryptedPHI),
    'lastUpdated' : IDL.Int,
    'encryptedMedicalHistory' : IDL.Opt(EncryptedPHI),
    'encryptedAllergies' : IDL.Opt(EncryptedPHI),
    'encryptedPersonalInfo' : IDL.Opt(EncryptedPHI),
  });
  ...
  const Result_23 = IDL.Variant({ 'ok' : IDL.Vec(Message), 'err' : IDL.Text });
  ...
  const Result_12 = IDL.Variant({ 'ok' : UserType, 'err' : IDL.Text });
  ...
  return IDL.Service({
    'assignUserRole' : IDL.Func([IDL.Principal, UserType], [Result], []),
    ...
    'checkOnboarding' : IDL.Func([], [IDL.Bool], ['query']),
    ...
    'exportAuditLogs' : IDL.Func(
        [IDL.Opt(IDL.Int), IDL.Opt(IDL.Int), IDL.Text],
        [Result],
        ['query'],
      ),
    'generateUserPHIKey' : IDL.Func([], [Result], []),
    'getAdminUsers' : IDL.Func([], [Result_34], ['query']),
    ...
    'getAuditSummary' : IDL.Func([IDL.Opt(IDL.Nat)], [Result_32], ['query']),
    'getChatAnalytics' : IDL.Func([], [Result_31], []),
    'getChatEndpoint' : IDL.Func([], [IDL.Text], []),
    'getCurrentUser' : IDL.Func([], [Result_30], ['query']),
    'getCurrentUserProfile' : IDL.Func([], [Result_1], ['query']),
    'getDoctorAppointments' : IDL.Func([], [IDL.Vec(Appointment)], ['query']),
    'getDoctorById' : IDL.Func([DoctorId], [Result_29], ['query']),
    'getEncryptedPatientPHI' : IDL.Func([UserId], [Result_28], ['query']),
    'getFaucetClaimHistory' : IDL.Func([], [IDL.Vec(FaucetClaim)], ['query']),
    'getFaucetStats' : IDL.Func([], [FaucetStats], ['query']),
    'getMedicalRecordById' : IDL.Func([RecordId], [Result_27], []),
    ...
    'getPatientProfile' : IDL.Func([], [Result_26], ['query']),
    'getPaymentStatistics' : IDL.Func([], [Result_25], ['query']),
    'getPrescriptions' : IDL.Func([UserId], [Result_24], ['query']),
    ...
    'getSessionNotes' : IDL.Func([UserId], [Result_22], ['query']),
    ...
    'getTherapistById' : IDL.Func([IDL.Text], [Result_21], ['query']),
    'getTherapistPricing' : IDL.Func(
        [IDL.Opt(UserId)],
        [IDL.Vec(SessionPricing)],
        ['query'],
      ),
    'getTherapistProfile' : IDL.Func([], [Result_21], ['query']),
    'getTokenEarningOpportunities' : IDL.Func([], [Result_20], ['query']),
    'getTokenSpendingOptions' : IDL.Func([], [Result_19], ['query']),
    'getTreatmentSummaries' : IDL.Func([UserId], [Result_18], ['query']),
    'getUserAccessPermissions' : IDL.Func([], [Result_17], ['query']),
    'getUserChatHistory' : IDL.Func([IDL.Opt(IDL.Text)], [Result_16], []),
    'getUserConsentRecords' : IDL.Func([], [IDL.Vec(ConsentRecord)], ['query']),
    'getUserEscrowContracts' : IDL.Func([], [Result_15], ['query']),
    'getUserPaymentPlans' : IDL.Func([], [Result_14], ['query']),
    'getUserPaymentTransactions' : IDL.Func([], [Result_13], ['query']),
    'getUserRole' : IDL.Func([IDL.Opt(IDL.Principal)], [Result_12], ['query']),
    ...
    'markOnboardingComplete' : IDL.Func([], [Result], []),
    ...
    'removeAdminPrivileges' : IDL.Func([IDL.Principal], [Result], []),
    'revokeAccess' : IDL.Func([IDL.Text, IDL.Text, UserId], [Result], []),
    'rotateUserPHIKey' : IDL.Func([], [Result], []),
    ...
    'storeEncryptedPatientPHI' : IDL.Func(
        [UserId, PHIDataType, IDL.Vec(IDL.Nat8)],
        [Result],
        [],
      ),
